...
public class BloodOrganizationClass {
    ...
    public BloodOrganizationClass(String bloodOrganizationId, String bloodOrganizationName, String bloodOrganizationEmail, String bloodOrganizationDivision, String bloodOrganizationDistric, String bloodOrganizationUpozila, List<String> bloods) {
