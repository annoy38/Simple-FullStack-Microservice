...
public class DonorInfoClass {
    ...
    public DonorInfoClass(String donarId, String bloodOrganizationId, String donarName, String donarEmail, int donarAge, String donarGender, String donarAddress, String donarBloodType, LocalDate localDate, String status) {
