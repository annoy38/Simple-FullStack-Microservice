...
public class OrganizationsInfoClass {
    @Id
    ...
    public OrganizationsInfoClass() {
    }

    public OrganizationsInfoClass(String accountId, String accountName, String accountNumber, String accountEmail, String accountDivision, String accountDistric, String accountUpazila, String orgType) {
