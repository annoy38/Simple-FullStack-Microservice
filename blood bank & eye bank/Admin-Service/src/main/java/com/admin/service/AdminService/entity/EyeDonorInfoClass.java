...
@Entity
@Table(name = "eye_donor_info")
public class EyeDonorInfoClass {
    ...
    public EyeDonorInfoClass() {
    }

    public EyeDonorInfoClass(String donorId, String eyeOrganizationId, String donorName, String donorEmail, int donorAge, String donorAddress, String donorBloodType, String donorGender) {
